    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center marb-35">
          <h1 class="header-h">Despre noi</h1>
          <p class="header-p">#hailamas&#259; </p>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-10">
          <div class="col-md-6 col-sm-6">
            <div class="about-info">
              <h2 class="heading">Alege o mas&#259; delicias&#259;!</h2>
              <p>Pe site-ul nostru vei gasi o gama de produse gastronomice variata ce te imbie la o masa delicioasa. </p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12  text-center" id="menu-flters">
            ...
            <form class="filter" action = "Produse" method = "Post">		  		    
		      <input type="submit" class="btn btn-warning" value = "Produse"/>
		</form><br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1 class="header-h">Contacteaz&#259;-ne</h1>
        ...
        <div class="col-md-4 col-sm-4 mr-15">
          <div class="media-2">
            ...
            <div class="media-body">
              <h4 class="dark-blue regular">Telefon</h4>
              <p class="light-blue regular alt-p">+40 754 222 222</p>
            </div>
          </div>
          <div class="media-2">
            <div class="media-left">
            ...
            <div class="media-body">
              <h4 class="dark-blue regular">Program</h4>
              <p class="light-blue regular alt-p"> De luni p&#226;n&#259; vineri <br>  09.00 - 24:00</p>
